...
// if ( webGLStatus ) {
	...
	******************/
	...
	function buildSequences() {
		...
		let model4DS01Path = 'https://storage.googleapis.com/risingstar_player/model/pitch';
		let model4DS01Audio = 'https://storage.googleapis.com/risingstar_player/model/sound.wav';
		let model4DS01Position = sequencePosition;
		
		// Sequence 01
		let model4DS01Placeholder = new WEB4DS(model4DS01Id, 'https://storage.googleapis.com/risingstar_player/model/pitch_placeholder.4ds', 'https://storage.googleapis.com/risingstar_player/model/pitch_placeholder_mobile.4ds', '', model4DS01Position, renderer, scene, camera)
