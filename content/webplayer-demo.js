...
// if ( webGLStatus ) {
	...
	******************/
	...
	function buildSequences() {
		...
		let model4DS01Path = 'https://testrisingstar.storage.googleapis.com/usher_dance/model';
		let model4DS01Audio = 'https://testrisingstar.storage.googleapis.com/usher_dance/audio.mp3';
		let model4DS01Position = sequencePosition;
		
		// Sequence 01
		let model4DS01Placeholder = new WEB4DS(model4DS01Id, 'https://testrisingstar.storage.googleapis.com/usher_dance/model.4ds', 'https://testrisingstar.storage.googleapis.com/usher_dance/model_mobile.4ds', '', model4DS01Position, renderer, scene, camera)
