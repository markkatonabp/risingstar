...
// if ( webGLStatus ) {
	...
	******************/
	...
	function buildSequences() {
		...
		let model4DS01Path = 'https://testrisingstar.storage.googleapis.com/usher_dance/pitch';
		let model4DS01Audio = 'https://testrisingstar.storage.googleapis.com/usher_dance/sound.wav';
		let model4DS01Position = sequencePosition;
		
		// Sequence 01
		let model4DS01Placeholder = new WEB4DS(model4DS01Id, 'https://testrisingstar.storage.googleapis.com/usher_dance/pitch_placeholder.4ds', 'https://testrisingstar.storage.googleapis.com/usher_dance/pitch_placeholder_mobile.4ds', '', model4DS01Position, renderer, scene, camera)
